<?php
/**
 * @Filename        TradeDayRepository.php
 *
...
class TradeDayRepository
{
    ...
    public function listFields()
    {
        ...
        return [
            ...
            ['dataIndex' => 'refund_count', 'title' => '退款订单数'],
            ['dataIndex' => 'goods_price_amount', 'title' => '商品总金额'],
            ['dataIndex' => 'coupon_shop_fee_amount', 'title' => '店铺优惠券金额'],
            ['dataIndex' => 'promotion_fee_amount', 'title' => '满减/满折金额'],
            ['dataIndex' => 'shop_act_fee_amount', 'title' => '店铺优惠汇总'],
...
//            ['dataIndex' => 'status_text', 'title' => '结算状态'],
    ...
    public function search($request,$downData='')
    {
        ...
        $Model = new TradeDaySettleAccount();
