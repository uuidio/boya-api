<?php
/**
 * @Filename ActivitiesRewardRepository.php
 *
...
class ActivitiesRewardRepository
{
    ...
    public function listFields()
    {
        return [
            ...
            ['dataIndex' => 'goods_info.goods_name', 'title' => '商品名称'],
            ['dataIndex' => 'goods_info.goods_serial', 'title' => '货号'],
            ['dataIndex' => 'goods_info.goods_barcode', 'title' => '条形码'],
            ['dataIndex' => 'goods_info.goods_image', 'title' => '商品图片'],
