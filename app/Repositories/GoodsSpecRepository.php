<?php
/**
 * @Filename GoodsSpecRepository.php
 *
...
class GoodsSpecRepository
{
    ...
    */
    protected $filterables = [
        'sp_name' => ['field' => 'sp_name', 'operator' => 'like'],
     ...
     * @return mixed
     */
    public function listSpec($data)
    {
        $goodsSkuModel = new GoodsSpec();
