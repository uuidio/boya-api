...
use ShopEM\Repositories\PlatformRoleRepository;
...
class RoleController extends BaseController
{
     ...
     */
    public function lists(PlatformRoleRepository $repository, Request $request)
    {
    ...
    {
        $role = PlatformRole::find(intval($request->id));
    ...
    public function create(RoleRequest $request)
    {
        ...
        try {
            ...
            //插入关联表
            PlatformRole::find($role->id)->roleToMenus()->sync($menus);
    ...
    public function delete(Request $request)
    {
        ...
        try {
            ...
            PlatformRoleMenu::where('role_id', $role->id)->delete();
            $role->delete();
            DB::commit();
            return $this->resSuccess();
        } catch (\Exception $exception) {
