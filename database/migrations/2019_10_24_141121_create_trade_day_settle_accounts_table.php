...
class CreateTradeDaySettleAccountsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trade_day_settle_accounts', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `" . prefixTableName('trade_day_settle_accounts') . "` comment '日结数据表'");
    }
    ...
    {
        Schema::dropIfExists('trade_day_settle_accounts');
    }
}
