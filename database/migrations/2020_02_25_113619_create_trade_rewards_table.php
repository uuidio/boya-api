...
class CreateTradeRewardsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trade_rewards', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `" . prefixTableName('trade_rewards') . "` comment '实际收益表'");
    }
    ...
    {
        Schema::dropIfExists('trade_rewards');
    }
}
