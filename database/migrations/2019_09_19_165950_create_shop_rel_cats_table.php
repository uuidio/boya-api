...
class CreateShopRelCatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('shop_rel_cats', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `" . prefixTableName('shop_rel_cats') . "` comment '商场店铺分类表'");
    }
    ...
    {
        Schema::dropIfExists('shop_rel_cats');
    }
}
