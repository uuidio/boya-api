...
class CreateGroupManageUsersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('group_manage_users', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `" . prefixTableName('group_manage_users') . "` comment '集团管理员账户表'");
    }
    ...
    {
        Schema::dropIfExists('group_manage_users');
    }
}
