...
class CreateGoodsSkusTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('goods_skus', function (Blueprint $table) {
            ...
            $table->unsignedTinyInteger('goods_state')->default(0)->comment('商品状态 0下架，1正常，10违规（禁售）');
            ...
            $table->string('goods_shop_cid',100)->nullable()->comment('店铺分类id 首尾用,隔开');
        ...
        DB::statement("ALTER TABLE `" . prefixTableName('goods_skus') . "` comment '商品sku表'");
    }
