...
class CreateGroupManageLogsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('group_manage_logs', function (Blueprint $table) {
        ...
        DB::statement("ALTER TABLE `" . prefixTableName('group_manage_logs') . "` comment '集团端操作日志'");
    }
    ...
    {
        Schema::dropIfExists('group_manage_logs');
    }
}
